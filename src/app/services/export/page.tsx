...
import { exportProducts, type Product } from "@/data/products";
    ...
    <>
      ...
      <section className="relative pt-32 pb-24 min-h-[500px] flex items-center">
        ...
        <div className="container-wide relative z-10 text-center">
          <FadeIn>
            <span className="eyebrow text-gold block mb-4">SERVICE: EXPORT</span>
        ...
        {submitted ? (
          <div className="text-center py-12">
            ...
            <p className="text-text-muted">
              Thank you for your interest in {selectedProduct?.name}. Our export specialists will contact you shortly.
            </p>
            <button
          ...
          <form onSubmit={handleFormSubmit} className="space-y-4">
            <p className="text-sm text-text-muted mb-6">
              Please provide the details below so we can assist with your export request for {selectedProduct?.name}.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-navy mb-1 uppercase tracking-wider">Port of Origin (Bangladesh)</label>
                <input required type="text" placeholder="e.g., Chattogram / Mongla" className="w-full bg-ivory border border-stone/40 px-4 py-2.5 rounded-sm focus:outline-none focus:border-terracotta" />
              </div>
              <div>
                <label className="block text-xs font-medium text-navy mb-1 uppercase tracking-wider">Available Volume / Capacity</label>
                <input required type="text" className="w-full bg-ivory border border-stone/40 px-4 py-2.5 rounded-sm focus:outline-none focus:border-terracotta" />
              </div>
            </div>

            <div>
              <label className="block text-xs font-medium text-navy mb-1 uppercase tracking-wider">Compliance Certificates Held</label>
              <textarea rows={3} placeholder="e.g., ISO, Oeko-Tex, BSTI, REACH" className="w-full bg-ivory border border-stone/40 px-4 py-2.5 rounded-sm focus:outline-none focus:border-terracotta resize-none"></textarea>
            </div>
