    ...
    <>
      <section className="relative pt-32 pb-24 min-h-[400px] flex items-center bg-navy text-white">
        <div className="absolute inset-0">
          <Image src="/images/global-trade-3.jpg" alt="Mission and Vision" fill className="object-cover" priority />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn>
              <div className="bg-warm-white p-10 md:p-14 rounded-sm border border-stone/30 shadow-sm relative">
                <div className="absolute -top-6 -left-6 w-12 h-12 bg-terracotta text-white flex items-center justify-center rounded-sm font-serif text-2xl font-bold">
                  M
                </div>
                <h3 className="font-serif text-3xl font-semibold text-navy mb-6">Our Mission</h3>
            ...
            <FadeIn delay={0.2}>
              <div className="bg-navy p-10 md:p-14 rounded-sm border border-navy shadow-sm relative text-white">
                <div className="absolute -top-6 -right-6 w-12 h-12 bg-gold text-navy flex items-center justify-center rounded-sm font-serif text-2xl font-bold">
                  V
                </div>
      ...
      <section className="section-padding bg-warm-white border-t border-stone/20">
        <div className="container-wide max-w-4xl text-center">
          <FadeIn>
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-navy font-semibold mt-4 mb-8">
              Partnership over Procurement
            </h2>
            <div className="space-y-6 text-text-muted leading-relaxed text-lg">
              <p>
                In the world of international trade, transactions are easy to come by, but true partnerships are rare. At Maple AG Global LTD, our philosophy is rooted in long-term collaboration. We do not view our clients merely as buyers, nor our suppliers merely as vendors. We are stakeholders in each other's success.
              </p>
              <p>
      ...
      <section className="section-padding bg-navy text-white">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { year: "2026", title: "Carbon Neutral", desc: "Achieve carbon neutrality across our warehousing and domestic logistics operations." },
              { year: "2027", title: "Global Hubs", desc: "Open direct liaison offices in Dubai and Frankfurt to shorten communication loops." },
              { year: "2028", title: "Blockchain Tracking", desc: "Implement blockchain-backed supply chain transparency for all textile exports." },
              { year: "2030", title: "Market Expansion", desc: "Expand our export footprint to 60+ countries, primarily penetrating Latin America." }
            ].map((goal, i) => (
              <FadeIn key={goal.year} delay={i * 0.1}>
                <div className="border-l-2 border-gold pl-6 py-2">
                  ...
                  <p className="text-white/60 text-sm leading-relaxed">{goal.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
